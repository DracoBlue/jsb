/*
 * JsBehaviourToolkit 1.2.2 - Native Version
 *
...
JsBehaviourToolkit = {
        ...
        if (input_element) {
            ...
            if (value_string.substr(0, 1) == '{') {
                ...
                var parts = value_string.split("&"),
                    ...
                    i, query_string_entry, value_key, value_content;
                for (i = 0; i < parts_length; i++) {
                    query_string_entry = parts[i].split("=");
                    value_key = decodeURIComponent(query_string_entry[0]);
                    value_content = decodeURIComponent(query_string_entry.slice(1).join("="));
    ...
    applyBehaviour: function(dom_element) {
        ...
        raw_dom_elements_length = raw_dom_elements.length;
        for (r = 0; r < raw_dom_elements_length; r++) {
